        ...
        if (0 === strpos($pathinfo, '/s')) {
            ...
            elseif (0 === strpos($pathinfo, '/s/dashboard')) {
                ...
                if (0 === strpos($pathinfo, '/s/dashboard/widget') && preg_match('#^/s/dashboard/widget/(?P<widgetId>[^/]++)$#sD', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, ['_route' => 'mautic_dashboard_widget']), array (  '_controller' => 'Mautic\\DashboardBundle\\Controller\\DashboardController::widgetAction',));
                }
            ...
            elseif (0 === strpos($pathinfo, '/s/reports')) {
                ...
                if (0 === strpos($pathinfo, '/s/reports/download') && preg_match('#^/s/reports/download/(?P<reportId>[^/]++)(?:/(?P<format>[^/]++))?$#sD', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, ['_route' => 'mautic_report_download']), array (  'format' => 'csv',  '_controller' => 'Mautic\\ReportBundle\\Controller\\ReportController::downloadAction',));
                }
                ...
                if (0 === strpos($pathinfo, '/s/reports/schedule')) {
                    ...
                    if (preg_match('#^/s/reports/schedule/(?P<reportId>[^/]++)/now$#sD', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, ['_route' => 'mautic_report_schedule']), array (  '_controller' => 'Mautic\\ReportBundle\\Controller\\ScheduleController::nowAction',));
                    }
            ...
            elseif (0 === strpos($pathinfo, '/s/grapesjsbuilder')) {
                ...
                if ('/s/grapesjsbuilder/upload' === $pathinfo) {
                    return array (  '_controller' => 'MauticPlugin\\GrapesJsBuilderBundle\\Controller\\FileManagerController::uploadAction',  '_route' => 'grapesjsbuilder_upload',);
                }

                // grapesjsbuilder_delete
                if ('/s/grapesjsbuilder/delete' === $pathinfo) {
                    return array (  '_controller' => 'MauticPlugin\\GrapesJsBuilderBundle\\Controller\\FileManagerController::deleteAction',  '_route' => 'grapesjsbuilder_delete',);
                }

                // grapesjsbuilder_builder
                if (preg_match('#^/s/grapesjsbuilder/(?P<objectType>[^/]++)(?:/(?P<objectId>[a-zA-Z0-9_-]+))?$#sD', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, ['_route' => 'grapesjsbuilder_builder']), array (  '_controller' => 'MauticPlugin\\GrapesJsBuilderBundle\\Controller\\GrapesJsController::builderAction',  'objectId' => 0,));
                }
